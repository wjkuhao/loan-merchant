...
var fmid = "fhindex";
var mid = "fhindex";
var locationHref = (window.location+'').split('#'); 
locationHref = locationHref[0];
function siMenu(id,fid,MENU_NAME,MENU_URL){
	window.location.href = locationHref+"#"+id;
	if(id != mid){
		$("#"+mid).removeClass();
		mid = id;
	}
...
$(function(){
	...
	if ($.cookie('skin')!= "undefined") {
		...
		hf(skin);
//		$("#skin-colorpicker option").each(function(obj){
//
//		});
	}
